...
const bodyContents =
  ...
  <p>If you're using a consent framework to conditionally enable your analytics provider, follow the instructions below and afterwards follow <a href="/docs/consent/">the guidance about adjusting for consent in this doc</a>.</p>
